...
public class PdfUtil {
    ...
    public static void main(String[] args) {
        try {
            //取得F盘下的pdf的内容
            readPdf("D:\\JAVA\\neo4j\\allApt\\src\\main\\resources\\pdf\\DarkHydrus delivers new Trojan that can use Google Drive for C2 communications.pdf");
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
        ...
        try {
            try {
                ...
                if (fileName.length() > 4) {
                    ...
                    textFile ="D:\\JAVA\\neo4j\\allApt\\src\\main\\resources\\pdf\\"+outputFile.getName();
                }
